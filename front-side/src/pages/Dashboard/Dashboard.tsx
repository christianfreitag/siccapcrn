  ...
  return (
    <div className="flex-col  h-full w-full p-1 overflow-y-auto">
        ...
        <div className="group cursor-pointer w-full flex-1 border-r-[1px] mt-8 mb-8  flex items-center justify-center">
          ...
          >
            <div className={`flex w-fit h-fit items-center justify-center`}>
              <div className=" border-[1px] p-2 rounded-lg border-brand-100">
                <FolderOpen className="group-hover:text-brand-100 text-lightBlack-100" weight="light" size={"2.5vw"} />
              </div>
      ...
      <div className={` flex  h-[calc(100%-16rem-3.5rem-2rem)] mt-4 rounded-md`}>
        <div className={`bg-zinc-800 shadow-md w-1/2 h-full rounded-md  #sm:bg-white #md:bg-red-100 md:min-h-[17rem] #lg:bg-blue-100 #xl:bg-green-100 mr-4`}>
          <div className=" w-full pt-2 pl-4 pb-2 bg-zinc-900 rounded-t-md font-medium text-2xl text-zinc-100 md:text-lg md:pb-1 md:pt-1">Relatórios</div>
        ...
        <div className={`w-1/2 h-full rounded-md flex-col`}>
          <div className={`bg-zinc-800 shadow-md w-full h-[50%] rounded-md  #sm:bg-white #md:bg-red-100 md:min-h-[8rem] #lg:bg-blue-100 #xl:bg-green-100 `}>
            <div className=" w-full pt-2 pl-4 pb-2 bg-zinc-900  rounded-t-md font-medium text-2xl text-zinc-100 md:text-lg md:pb-1 md:pt-1">Afastamentos</div>
          ...
          <div className={`bg-zinc-800 shadow-md w-full h-[47%] mt-4 rounded-md  #sm:bg-white #md:bg-red-100 md:min-h-[8rem] #lg:bg-blue-100 #xl:bg-green-100 `}>
            <div className=" w-full pt-2 pl-4 pb-2 bg-zinc-900 rounded-t-md font-medium text-2xl text-zinc-100 md:text-lg md:pb-1 md:pt-1">Analistas</div>
            <div className="w-full h-[45%] flex items-center  mt-[3vh]">
              <div className="group cursor-pointer w-1/2 flex items-center justify-center">
