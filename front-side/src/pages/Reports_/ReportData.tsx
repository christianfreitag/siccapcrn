...
export function ReportData() {
  ...
  return loadPage ? (
    <div className={` w-full  h-full overflow-y-scroll overflow-x-hidden relative p-1`}>
      ...
      <div className={` bg-white h-[18%]  min-h-[8rem] w-full  p-2 rounded-lg shadow-sm relative `}>
      ...
      <div className={` bg-white  h-fit min-h-[6rem] w-full mt-2  rounded-lg shadow-sm relative p-4`}>
