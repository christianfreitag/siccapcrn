...
export function ListTitles({
  ...
  return (
    <div className=" p-1 flex w-full h-[3rem] text-lightBlack-100 justify-start font-bold text-[0.80rem] bg-gray-100 shadow-sm rounded-b-none  md:text-sm items-center">
