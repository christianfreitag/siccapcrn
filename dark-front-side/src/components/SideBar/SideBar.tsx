              ...
              >
                {
                  <div className="relative ">
                    ...
                    <div className="absolute h-[0.80rem] w-[0.80rem] bg-notify-500 rounded-full top-2 -right-2 text-[0.6rem] flex items-center justify-center text-black">{
                    ...
                    <value.icon
                      ...
                      className={
                        `${buttonSelected != index
                          ...
                          : "transition-all duration-200 text-zinc-400 mt-3 bg-zinc-800 bg- p-1.5 w-8 h-8 rounded-md "}`
                      }
