...
export function Departures() {
  ...
  return (
    <div className={`h-full w-full overflow-hidden  rounded-md p-6 bg-zinc-800`}>
      {/*HEADER FILTER */}
      ...
      <div className={`h-auto overflow-y-scroll min-h-fit max-h-[60%] w-full p-1`}>
                ...
                >
                  <div className={`flex justify-start ml-2`}>
                    ...
                    <span className="flex-1 flex items-center ml-4">
                      <div className="flex bg-neutral-900 flex-wrap rounded-md p-1 items-center border-b-[2px] border-b-brand2-100  ">
        ...
        </div> : <div className="w-full h-20 flex items-center justify-center text-xl text-lightBlack-100"><FolderNotchOpen weight="thin" size={"80%"} className={"text-zinc-400 w-fit"} /> <p className="p-5">Nenhum item encontrado.</p></div>}
      </div>
