      ...
      <div>
        <div className="border-b-[1px] pb-2 pl-2 pr-4 mb-2">
          ...
          <Select
            ...
            className="z-50 w-full pl-6 pr-2 my-react-select-container"
        ...
        <div className="w-full flex h-12 border-b-[1px] pb-2 pl-2 pr-4 ">
          <Select
            placeholder="Status"
            className="z-40 w-full pl-6 pr-2 my-react-select-container"
            classNamePrefix="my-react-select"
            maxMenuHeight={200}
            value={
  ...
  return (
    <div className={`h-full w-full  rounded-md   flex-row overflow-y-auto `}>
      ...
      <div className="flex w-full  min-h-[32rem]  flex-1 ">
        <div className=" w-full min-h-[32rem]   rounded-md  relative  bg-zinc-800  ">
          {/* Gerando as tab's de cada um dos dias da semana */}
          <div className="h-[3.5rem] w-full flex justify-between items-center  bg-black">
            {weekNames.map((v) => {
              return (
                                ...
                                ${
                                  creating
                                    ? schedEnd == "" &&
                                      ...
                                      ? "hover:border-notify-500  border-zinc-600 "
                                      : "hover:border-notify-500  border-zinc-600"
                                    : "border-zinc-600 hover:border-gray-200"
                                }
                          ...
                          .map((dep: departureType, indexDep) => {
                            return moment(
                              ...
                              <div
                                ...
                                className={` h-[2vh] shadow-md  mt-[0.5px] overflow-hidden  flex text-xs  justify-center items-center text-white
                                                        ${
                                                          !creating && !editing
                                                            ? "cursor-pointer"
                                                            : null
        ...
        {
          <div className="bg-zinc-800 ml-2  rounded-md w-[60%]">
            {/* Navegador do calendario com mes e ano */}
            <div className="flex items-center w-full h-[6vh] shadow-sm justify-center ">
              <CaretLeft
                size={"40%"}
                className="text-lightBlack-100 cursor-pointer h-8 w-8 rounded-full p-1 hover:bg-neutral-900"
                onClick={() => {
                  changeMonth("l");
                }}
              />
              ...
              {!departureSelected && creating == false && editing == false ? (
                <>
                  <div className="noselect shadow-sm min-h-[4rem]  h-[6vh] p-2 flex">
                    ...
                    {/* Botão de criar novo  */}
                    <div
                      className="w-[6rem] h-10  rounded-md bg-neutral-900 text-lightBlack-10 flex justify-center items-center ml-4 cursor-pointer  hover:ring-[0.1rem] ring-brand-100"
                      onClick={() => {
                        setCreating(true);
                        clearFields();
                      }}
                    ...
                    >
                      ...
                      <PopoverContent
                        className={`rounded-md h-[13rem] pb-2 pt-4  w-[30rem] shadow-md p-0 duration-75 ml-2  bg-zinc-600 border-0 `}
                      >
                        <FilterDeparture />
                      </PopoverContent>
                    </Popover>
                    ...
                    <div className="rounded-md  w-32  h-10 ml-4 flex">
                      ...
                      <div className="bg-zinc-800 w-10 h-10 ml-2  flex items-center justify-center">
                        {page}/
                        {totalDepartures / 8 > 0
                  ...
                  <div className="noselect h-[6vh]  bg-neutral-900 flex justify-between items-center pl-6 shadow-sm">
                    ...
                    {departures.map((v:departureType, index) => {
                      return (
                        <div
                          ...
                          className="noselect w-full border-b-[1px] pt-3  p-2 pl-4 flex cursor-pointer hover:bg-neutral-900 "
                        >
                          ...
                          <div className="flex-1 ">
                            <div
                              className=" flex flex-wrap items-center
                                        "
                            >
                              <div className="font-semibold bg-neutral-900  rounded-md p-1  border-b-[2px] border-b-brand2-100 w-fit ">
                                {moment(
                                  v.date_sche_ini,
                                  "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]"
                                ).format("DD/MM/YY")}
                ...
                <div className="overflow-y-auto min-h-[32rem]">
                  <div className=" min-h-[3rem] justify-between flex items-center pl-4 pr-4 shadow-sm bg-neutral-900 ">
                    ...
                    <X
                      size={"1.9rem"}
                      weight={"bold"}
                      className="cursor-pointer  bg-neutral-700 p-1 rounded-md text-lightBlack-100 hover:bg-opacity-60 h-full"
                      onClick={() => {
                        setDepartureSelected(undefined),
                          setCreating(false),
                          setEditing(false),
                  ...
                  <div className="flex-row p-6 ">
                    ...
                    <div className="flex h-15 w-[100%] rounded items-center justify-between mt-2">
                      <div className=" w-[50%] flex items-center h-full  f">
                        <div className="border-[1px] min-h-[2.5rem] border-zinc-300 h-[4vh] w-full rounded-md  pl-2  text-zinc-400 font-thin flex items-center ">
                      ...
                      <div className=" w-[48%] flex items-center h-full ">
                        <div className="border-[1px] min-h-[2.5rem] border-zinc-300 h-[4vh] w-full rounded-md  text-zinc-400 pl-2 font-thin flex items-center">
                    ...
                    {creating ? (
                      <Select
                        ...
                        className=" flex-1 z-50 mt-3 my-react-select-container"
                        classNamePrefix="my-react-select"
                        maxMenuHeight={200}
                        options={analystList}
                        isClearable={true}
                      ...
                      <div className="h-10 w-full bg-black  flex-1 mt-6 rounded-md border-[1px] border-zinc-300 flex items-center pl-3 justify-between ">
                        <div>
                    ...
                    <div className="flex items-end h-fit mt-6 ">
                      {creating ? (
                        <Select
                          ...
                          className="z-40 w-full my-react-select-container"
                          classNamePrefix="my-react-select"
                          maxMenuHeight={200}
                          isClearable={true}
                          isDisabled={!creating && !editing}
                        ...
                        //@ts-ignore
                        <div className="h-fit w-full bg-neutral-900 p-2 rounded-md border-[1px] border-zinc-300">
                          ...
                          <div
                            className={`border-[1px] min-h-[2.5rem] ${
                              departureIni
                                ? "border-green-500"
                                : "border-notify-500"
                            } h-[4vh] w-full rounded-md  pl-2  text-zinc-400 font-thin flex items-center `}
                          >
                            <span className=" noselect ">De:</span>{" "}
                            <input
                            onDoubleClick={()=>{
                          ...
                          <div
                            className={`border-[1px] min-h-[2.5rem] ${
                              departureEnd
                                ? "border-green-500"
                                : "border-notify-500"
                            } h-[4vh] w-full rounded-md  text-zinc-400 pl-2 font-thin flex items-center`}
                          >
                            <span className=" noselect">Até:</span>
                            <input
                            onDoubleClick={()=>{
