  ...
  return id != "novo" ? (
    <div className={`w-full h-fit bg-zinc-800 rounded-md mt-4 relative`}>
...

      {
        ...
        ) : null /*<div className=" flex justify-center h-10 items-center pr-20">Não foi encontrado nenhuma solicitação. Aperte em <span className="text-zinc-400 font-semibold flex items-center pl-2 pr-2"> <PlusCircle size={"1.2rem"} weight={"light"} /> Novo </span> para criar uma.</div>*/
      }
