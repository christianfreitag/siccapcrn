...
export function RequestData() {
  ...
  return loadPage ? (
    <div className={` w-full h-full overflow-y-auto`}>
      ...
      <div className={`w-full min-h-[40rem] h-fit bg-zinc-800 rounded-md relative`}>
                  ...
                  return (
                    <div key={i.id} className={`flex items-center justify-between pl-6 pr-6 h-[4rem] border-b-[1px]`}>
                      ...
                      <Popover dismiss={{ ancestorScroll: true }} placement="bottom-end">
                        ...
                        <PopoverContent className={`rounded-sm h-fit pb-2 pt-4  w-[10rem] shadow-md p-0 duration-75 ml-2  bg-zinc-600 border-0 `}>
            ...
            >
              {
                //@ts-ignore
                (close) => (
                  <div className={`w-[50rem] h-[13rem] bg-zinc-800 rounded-md `}>
                    <div className={`w-full h-[3rem]  rounded-t-md justify-between flex items-center shadow-sm`}>
                      <div className="font-semibold text-zinc-400 ml-4">Novo investigado</div>
                      <div
                        className={`h-7 w-7 rounded-md bg-black text-zinc-400 mr-2 flex items-center  justify-center cursor-pointer hover:bg-brand-100 hover:text-white duration-700`}
                        onClick={() => {
                          close();
                          setCreateInvestigatedIsSubmited(false);
                        }}
                    ...
                    <div className={`w-full h-[7rem] bg-zinc-800-50 rounded-t-md  justify-between  flex items-center pr-4 pl-4 `}>
                    ...
                    <div className={`w-full h-[4rem] bg-black rounded-b-md justify-end flex items-center`}>
                      <div>
                        <Button
                          text="Criar"
