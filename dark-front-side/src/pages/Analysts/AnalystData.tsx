...
export function AnalystData() {
  ...
  return loadPage ? (
    <div className={` w-full h-full overflow-y-auto`}>
      ...
      <div className={`w-full min-h-[20rem] h-fit pb-[8rem] bg-zinc-800 rounded-md relative`}>
        <div>
        ...
        <div>
          ...
          <div className={`w-full h-fit bg-zinc-800 rounded-md mt-4 relative`}>
            ...
            <div className={`w-full h-fit 0 flex-row `}>
              <div className={`w-full min-h-[4rem]   p-2 bg-black`}>
                <div className="flex  items-center flex-wrap  justify-between">
                  <div className="rounded-md   h-10  flex mb-2 ">
                    <div className=" flex">
                      ...
                      >
                        <CaretLeft className={`${Math.ceil(totalReportsCount / 8) > 0 && pageReports > 1 ? "text-zinc-400" : "text-gray-300 "}`} />
                      </div>
                      ...
                      >
                        <CaretRight className={`${Math.ceil(totalReportsCount / 8) > 0 && pageReports < Math.ceil(totalReportsCount / 8) ? "text-zinc-400" : "text-gray-300 "}`} />
                      </div>
                    </div>
                    <div
                      title="Resetar filtros"
                      className=" mb-2 flex items-center justify-center ml-2 bg-neutral-900 h-10 w-10 rounded-md mr-2 hover:text-purple-600 cursor-pointer"
                      onClick={() => {
                    ...
                    <Select
                      placeholder="Tipo"
                      className="z-40  mr-2 mb-2 w-[20vw] min-w-[2rem] my-react-select-container"
                    ...
                    <Select
                      placeholder="Status"
                      className="z-40  mr-2 max-w-[18rem]   mb-2 min-w-[2rem] my-react-select-container"
                      classNamePrefix="my-react-select" 
                      maxMenuHeight={200}
                      onChange={(e) => {
                  ...
                  <div className="h-[2.4rem] w-[52%] flex items-center mb-2 min-w-[20rem] max-w-[50rem]">
                    ...
                    <div className="h-full w-[50%] bg-zinc-800 rounded-sm flex items-center mr-2 ">
                      <input
                        type={"date"}
                    ...
                    <div className="h-full w-[50%] bg-zinc-800 rounded-sm flex items-center ml-2  ">
                      <input
                        type={"date"}
          ...
          <div className={`w-full h-fit bg-zinc-800 rounded-md mt-4 relative`}>
            ...
            <div className={`w-full h-fit 0 flex-row `}>
              <div className={`w-full min-h-[4rem] xl:h-[4rem] 2xl:h-[4rem]  p-2 bg-black`}>
                <div className="flex  items-center flex-wrap  ">
                  <div className="rounded-md  w-32  h-10  flex mb-2 ">
                    ...
                    >
                      <CaretLeft className={`${Math.ceil(totalDeparturesCount / 8) > 0 && pageDepartures > 1 ? "text-zinc-400" : "text-gray-300 "}`} />
                    </div>
                    <div className="bg-zinc-800 w-10 h-10 ml-2  flex items-center justify-center">
                    ...
                    >
                      <CaretRight className={`${Math.ceil(totalDeparturesCount / 8) > 0 && pageDepartures < Math.ceil(totalDeparturesCount / 8) ? "text-zinc-400" : "text-gray-300 "}`} />
                    </div>
                  </div>
                  <div
                    title="Resetar filtros"
                  ...
                  <Select
                    placeholder="Tipo"
                    className="z-40  mr-2 mb-2 max-w-[25rem] min-w-[2rem] my-react-select-container"
                    classNamePrefix="my-react-select"
                    maxMenuHeight={200}
                  ...
                  <Select
                    placeholder="Filtro"
                    className="z-40   mr-2 max-w-[18rem] min-w-[2rem] mb-2 my-react-select-container"
                    classNamePrefix="my-react-select"
                    maxMenuHeight={200}
    ...
    <div className=" w-full h-full  flex items-center justify-center">
      <div className="">
        ...
        <div
          ...
          className="w-full flex justify-center rounded-md h-10  items-center underline font-bold text-zinc-400 hover:text-notify-500 cursor-pointer"
        >
          Voltar
        </div>
      </div>
