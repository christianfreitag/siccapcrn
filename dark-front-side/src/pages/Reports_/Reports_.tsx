    ...
    return (
      <div>
        ...
        <div className="w-full flex h-12 pl-2 pr-4 border-b-[1px] pb-2">
          ...
          <div className="h-10 w-12 bg-neutral-900 flex items-center justify-center rounded-md hover:bg-neutral-900 cursor-pointer"
          onClick={()=>{
        ...
        <div className="w-full flex h-12 pl-2 pr-4 border-b-[1px] pb-2 mt-2">
          ...
          <Select
          className="w-full  z-50 my-react-select-container"
        ...
        <div className="w-full flex h-12 pl-2 pr-4 border-b-[1px] pb-2 mt-2">
          ...
          <Select
          className="w-full z-40 my-react-select-container"
          classNamePrefix="my-react-select"
  ...
  return (
    <div className={`h-full w-full overflow-hidden  rounded-md pt-6 bg-zinc-800`}>
      ...
      <div className={`h-[6%] min-h-[3rem] w-full flex bg-black p-1`} onClick={() => {}}>
        ...
        <Select
          placeholder="Status"
          className="z-40  mr-4  min-w-[8rem] flex-1 my-react-select-container"
          classNamePrefix="my-react-select"
          maxMenuHeight={200}
          onChange={(e) => {
        ...
        >
          <PopoverHandler>
            <div
              className={`cursor-pointer h-10 w-10 mr-4 ${(filterAnalyst||filterTypeReport||dateFilterFromReport||dateFilterToReport) ? "bg-brand-100 text-white" : "bg-neutral-900"} rounded-md flex items-center justify-center`}
              onClick={() => {
          ...
          <PopoverContent className={`rounded-md h-[14rem] pb-2 pt-4  w-[30rem] shadow-md p-0 duration-75 ml-2 bg-zinc-600 border-0 `}>
            <FiltersReport />
          </PopoverContent>
        </Popover>
        <div className=" flex">
          ...
          >
            <CaretLeft className={`${Math.ceil(totalReports / 8) > 0 && page > 1 ? "text-zinc-400" : "text-gray-300 "}`} />
          </div>
          ...
          >
            <CaretRight className={`${Math.ceil(totalReports / 8) > 0 && page < Math.ceil(totalReports / 8) ? "text-zinc-400" : "text-gray-300 "}`} />
          </div>
        </div>
      </div>
                ...
                return (
                  <div key={index} className={` pl-2 w-full justify-start  p-[1%] lg:text-[0.92rem]  md:text-sm ${index != reports.length - 1 ? "border-b-[1px]" : ""}`}>
                    <div className={`flex justify-start`}>
                      ...
                      >
                        <Download size={"20px"} className={`${value.file ? "text-zinc-400" : "text-gray-200"}`} />
                      </span>
                    </div>
                  </div>
                );
      ...
      <div className="bg-neutral-900 w-full  flex items-center justify-center cursor-pointer hover:bg-opacity-50">Total: {totalReports}</div>
    </div>
  );
}
