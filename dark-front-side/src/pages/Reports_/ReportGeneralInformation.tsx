...
export function ReportGeneralInformation({
  ...
  return (
    <div className="h-fit mt-8 bg-zinc-800 p-3 rounded-lg shadow-sm">
      ...
      <div className={` h-fit p-2 pb-16 relative`}>
        <div className={`flex flex-wrap w-full h-fit p-1 `}>
          ...
          <div className={`flex-1 mt-6 min-w-[8rem]`}>
            <Select
              placeholder="Tipo"
              className="z-40  min-w-[3rem] my-react-select-container"
        ...
        <form
          ...
          className={` w-full flex  p-1 mt-4 h-[30vh] md:h-[15vh] justify-center border-dashed border-[2px] 
                ${fieldEnabled ? "border-gray-200 bg-black" : dragActive && !fieldEnabled ? "border-notify-500" : "border-zinc-300 bg-zinc-700"} rounded-md  items-center`}
        >
          {fieldEnabled ? (
            <div className=" w-[50%] flex justify-center">
              {fileName ? (
                <div
                  className="flex font-semibold items-center text-xl text-zinc-400 cursor-pointer hover:bg-neutral-900 p-2 rounded-md"
                  onClick={() => {
                    downloadReport();
                  }}
                >
